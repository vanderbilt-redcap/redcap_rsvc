Feature: A.2.33.1500.: The system shall display a project-level ACG Compliance page to administrators.---Project → Access Control Groups → Project

     As a REDCap end user
     I want to see The system shall display a project-level ACG Compliance page to administrators.---Project → Access Control Groups → Project

    Scenario: Setup
        Given I login to REDCap with the user "Test_Admin"
        And I create a new project named "A.2.33.1500." by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file "Project_1.xml", and clicking the "Create Project" button
    ...
    Scenario: A.2.33.1500.: The system shall send ACG alerts only when triggered manually by an administrator.---Alerts Table & Compliance Alert Logs
        ...
        And I click on the link labeled "A.2.33.1500"
