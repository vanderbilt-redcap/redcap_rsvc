Feature: A.2.33.2000.: The system shall provide filters for all ACG report columns.---Reports UI

     As a REDCap end user
     I want to see the system shall provide filters for all ACG report columns.---Reports UI

    Scenario: Setup
        Given I login to REDCap with the user "Test_Admin"
        And I create a new project named "A.2.33.2000." by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file "Project_1.xml", and clicking the "Create Project" button
    ...
    Scenario: A.2.33.2000.: The system shall provide filters for all ACG report columns.---Reports UI
       ...
       And I select "PID 13 a2332000" on the dropdown field labeled "Filter projects..."
