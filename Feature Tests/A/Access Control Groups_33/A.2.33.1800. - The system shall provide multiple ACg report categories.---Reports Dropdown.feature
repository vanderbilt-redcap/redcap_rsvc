Feature: A.2.33.1800.: The system shall provide multiple ACG report categories.---Reports Dropdown

     As a REDCap end user
     I want to see the system shall provide multiple ACG report categories.---Reports Dropdown

    Scenario: Setup
        Given I login to REDCap with the user "Test_Admin"
        And I create a new project named "A.2.33.1800." by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file "Project_1.xml", and clicking the "Create Project" button
    ...
    Scenario: A.2.33.1800.: The system shall provide multiple ACG report categories.---Reports Dropdown
