Feature: A.2.33.1000.: The system shall display system-wide ACG reports.---Control Center → ACG → Reports

     As a REDCap end user
     I want to see the system shall display system-wide ACG reports.---Control Center → ACG → Reports
 
    Scenario: Setup
        Given I login to REDCap with the user "Test_Admin"
        And I create a new project named "A.2.33.1000." by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file "Project_1.xml", and clicking the "Create Project" button
    ...
    Scenario: A.2.33.1000.: The system shall display system-wide ACG reports.---Control Center → ACG → Reports
