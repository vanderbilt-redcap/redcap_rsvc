Feature: A.2.33.0600.: The system shall allow designating one ACG as the Default ACG

    As an Admin
    I want to see that I can allow designating one ACG as the Default ACG.

    Scenario: A.2.33.0600.: The system shall allow designating one ACG as the Default ACG
        ...
        And I click on the checkbox labeled "Make this ACG the Default Group?"
