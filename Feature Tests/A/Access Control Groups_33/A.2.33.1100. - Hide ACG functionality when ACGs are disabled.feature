Feature: The system shall hide ACG functionality when ACGs are disabled.---System-Level (Control Center + All Projects)
   
    As a REDCap end user
    I want to see that the system hides ACG functionality when ACGs are disabled.---System-Level (Control Center + All Projects)

    Scenario: #SETUP
        Given I login to REDCap with the user "Test_Admin"
        And I create a new project named "A.2.33.1100." by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file "Project_1.xml", and clicking the "Create Project" button
        ...
        And I click on the link labeled "A.2.33.1100."
