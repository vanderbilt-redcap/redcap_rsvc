Feature: B.2.33.4400.: The system shall provide filters on the ACG Compliance page.---Project Compliance → Filters

     As a REDCap end user
     I want to see The system shall provide filters on the ACG Compliance page.---Project Compliance → Filters
     So that I can easily filter the user list on the ACG Compliance page to identify users

        Scenario: #SETUP
        Given I login to REDCap with the user "Test_Admin"
        And I create a new project named "B.2.33.4400." by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file "Project_1.xml", and clicking the "Create Project" button
    ...
    Scenario: B.2.33.4400.: The system shall provide filters on the ACG Compliance page.---Project Compliance → Filters
        Given I click on the link labeled "My Projects"
        And I click on the link labeled "B.2.33.4400."
        And I click on the link labeled "ACGs"
        Then I should see "Display Users"

        When I click on the button labeled "Display Users"
        Then I should see "Expired Users"
        And I should see "Non-Expired Users"
        And I should see "Users with Non-compliant Rights"
        And I should see "Users without Non-compliant Rights"   
        And I should see "User Rights Managers"
        
        When I click on the button labeled "Display Users"
        Then I should see a table header and rows containing the following values in a table: 
        || Username   | Full Name   | Email                | Expiration           | Access Control Group   | Non-compliant Rights    | Project Role                       |
        || test_admin | Admin User  | test_admin@test.edu  | never                | ()                     | 19 Non-compliant Rights | None                               |
        || test_user1 | Test User1  | Test_User1@test.edu  | never                | ()                     | 8 Non-compliant Rights  | None                               |
