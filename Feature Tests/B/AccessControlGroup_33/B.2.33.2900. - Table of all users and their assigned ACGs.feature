Feature: The system shall display a table of all users and their assigned ACGs.---User Assignments

    As a REDCap end user
    I want to see the system shall display a table of all users and their assigned ACGs.---User Assignments

    Scenario: B.2.33.2900.: The system shall display a table of all users and their assigned ACGs.---User Assignments
