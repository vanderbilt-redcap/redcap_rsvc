Feature: B.2.33.4800.: The system shall allow deleting scheduled ACG alerts.---Compliance Alert Logs → Delete

     As a REDCap Administrator 
     I want to be able to delete scheduled ACG alerts
        So that I can remove alerts that are no longer needed from the Compliance Alert Logs.

        Scenario: #SETUP
        Given I login to REDCap with the user "Test_Admin"
        And I create a new project named "B.2.33.4800." by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file "Project_1.xml", and clicking the "Create Project" button
    ...
    Scenario: B.2.33.4800.: The system shall allow deleting scheduled ACG alerts.---Compliance Alert Logs → Delete
        Given I click on the link labeled "My Projects"
        And I click on the link labeled "B.2.33.4800."
    ...
    #Validate the alert can be deleted.
        ...
        Then I should see "Deleted 1 alert."
