Feature: The system shall block assignment of privileges that exceed the user’s ACG.---Project → User Rights
   
    As a REDCap end user
    I want to see the system does not allow for project level rights to be assigned to a user that exceed the privileges of the user's assigned ACG.---Project-Level Enforcement
    ...
    Scenario: #SETUP
        ...
        When I create a new project named "B.2.33.3500." by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file "Project_1.xml", and clicking the "Create Project" button
        Then I should see "Your new REDCap project has been created"



    Scenario: B.2.33.3500.: The system shall block assignment of privileges that exceed the user’s ACG.---Project → User Rights
