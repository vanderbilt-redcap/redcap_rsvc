Feature: User Interface: The system shall support ranges for the following data types:  Date (Y-M-D) | Datetime (Y-M-D H:M) | Datetime w/seconds (Y-M-D H:M:S) | Integer | Number | Number (1 Decimal Place,  comma as decimal) | Time (HH:MM)  | Time (MM:SS) | Time (HH:MM:SS)
    ...
    Scenario: B.4.8.0300.100 Field range validation
        ...
        And I should see a button labeled "Publish" in the row labeled "Time (MM:SS)"
        When I click on the button labeled "Publish" in the row labeled "Time (MM:SS)"
        ...
        When I click on the button labeled "Publish" in the row labeled "Number (1 decimal place)"
        ...
        Then I should see a table header and rows containing the following values in the logging table:
            ...
            | test_admin | Create record 5 (Event 1 (Arm 1: Arm 1)) | date_ymd = '2023-08-02'                   |
            | test_admin | Create record 5 (Event 1 (Arm 1: Arm 1)) | datetime_ymd_hm = '2023-09-02 12:12'      |
            | test_admin | Create record 5 (Event 1 (Arm 1: Arm 1)) | datetime_ymd_hmss = '2023-09-02 12:12:12' |
            | test_admin | Create record 5 (Event 1 (Arm 1: Arm 1)) | integer = '3'                             |
            | test_admin | Create record 5 (Event 1 (Arm 1: Arm 1)) | number = '3'                              |
            | test_admin | Create record 5 (Event 1 (Arm 1: Arm 1)) | number_dec = '1.5'                        |
            | test_admin | Create record 5 (Event 1 (Arm 1: Arm 1)) | num_comma = '1,5'                         |
            | test_admin | Create record 5 (Event 1 (Arm 1: Arm 1)) | time_hhmm = '11:11'                       |
            | test_admin | Create record 5 (Event 1 (Arm 1: Arm 1)) | time_mm_ss = '11:11'                      |
            | test_admin | Create record 5 (Event 1 (Arm 1: Arm 1)) | time_hhmmss = '11:11:11'                  |
        ...
        Then I should see a table header and rows containing the following values in the logging table:
            | Username   | Action                                  | List of Data Changes OR Fields Exported |
            | test_admin | Create record 6 (Event 1 (Arm 1: Arm 1)) | date_ymd = '2022-08-02'                 |
