...
And I click on the "Enable" button for the field labeled "Clinical Data Pull from EHR" 
# When I click on the button labeled "Clinical Data Pull"

# #VERIFY
Then  I should see a dialog containing the following text: "Set up Clinical Data Pull" 