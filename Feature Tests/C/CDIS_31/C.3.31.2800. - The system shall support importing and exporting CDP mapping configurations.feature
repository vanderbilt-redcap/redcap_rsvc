Feature: C.3.31.2800. User Interface: The system shall support importing and exporting CDP mapping configurations, including field linkages. As a REDCap end user
    ...
    Scenario: Setup for CDP-enabled project
    #Activate CDIS Settings
     ...
     #SET UP NEW PROJECT
        Given I login to REDCap with the user "Test_Admin"
        And I create a new project named "C.3.31.2800" by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file "CDPTESTProject.xml", and clicking the "Create Project" button
        Then I should see "C.3.31.2800"
