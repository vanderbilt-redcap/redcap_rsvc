Feature: C.3.31.0900. Control Center: The system shall support displaying custom instructions or institution-specific requirements for enabling CDP, including HTML formatting.

    As a REDCap end user
    I want to see that the custom text specific to your institution to display to users is functioning correctly

    Scenario: C.3.31.0900. Control Center: The system shall support displaying custom instructions or institution-specific requirements for enabling CDP, including HTML formatting.
