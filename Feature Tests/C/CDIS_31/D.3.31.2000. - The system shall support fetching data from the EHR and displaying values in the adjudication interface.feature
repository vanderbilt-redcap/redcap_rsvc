Feature: D.3.31.2000. User Interface: The system shall support fetching data from the EHR using FHIR and displaying values in the CDP adjudication interface.
    As a REDCap end user
    I want to see that a project can have data pulled and viewed on the adjudication page.

    Scenario: D.3.31.2000. User Interface: The system shall support fetching data from the EHR using FHIR and displaying values in the CDP adjudication interface.
    ...
    #SET UP SMARTHEALTH IT IN CONTROL CENTER 
     ...
     #Turn on CDP at the project level
        Given I login to REDCap with the user "Test_Admin"
        And I create a new project named "D.3.31.2000" by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file "CDPTESTProject.xml", and clicking the "Create Project" button
        Then I should see "D.3.31.2000"
    ...
    #VERIFY LOG
        ...
        And I click on the link labeled "D.3.31.2000"    
