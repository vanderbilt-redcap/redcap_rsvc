...
#Validation that a new CDM project can not be created when CDM is disabled
When I click on the link labeled "New Project"
Then I should NOT see "Clinical Data Mart: Create a project and pull multiple medical records from eStar"
