Feature: C.3.31.1800. User Interface: The system shall support defining day offsets for temporal field mapping to control the data retrieval window.
   ...
   Scenario: C.3.31.1800. User Interface: The system shall support defining day offsets for temporal field mapping to control the data retrieval window. #Activate CDIS Settings
      When I enter "365" into the field labeled "Default day offset (for temporal fields):"
      And I click on the button labeled "Save"
