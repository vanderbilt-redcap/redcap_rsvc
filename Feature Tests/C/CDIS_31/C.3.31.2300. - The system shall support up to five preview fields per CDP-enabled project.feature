Feature: C.3.31.2300. User Interface: The system shall support up to five preview fields per CDP-enabled project.
    ...
    #Activate CDIS Settings
     ...
     #SET UP NEW PROJECT
        Given I login to REDCap with the user "Test_Admin"
        And I create a new project named "C.3.31.2300" by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file "CDPTESTProject.xml", and clicking the "Create Project" button
        Then I should see "C.3.31.2300"
